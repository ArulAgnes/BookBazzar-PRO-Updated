<?php
	...
	if(isset($_POST['add'])){
		...
		$query = "INSERT INTO books (book_isbn, type, book_title, book_author, book_image, book_descr, book_price, publisherid, categoryid)
		VALUES ('" . $isbn . "','" . $type . "',  '" . $title . "', '" . $author . "', '" . $image . "', '" . $descr . "', '" . $price . "', '" . $publisherid . "', '" . $categoryid . "')";
